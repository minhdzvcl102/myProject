            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <form action="/admin/banners/update/{{$data['id']}}" method="post" enctype="multipart/form-data">
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    ...
                                    <img src="{{ file_url($data['img']) }}" width="100px" alt="">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <select class="form-select" name="is_active" id="is_active">
                                        <option @if ($data['is_active'] == 1) selected @ @endif value="1">Active
                                        </option>
                                        <option @if ($data['is_active'] == 1) selected @ @endif value="0">Un Active
                                        </option>
                                    </select>
                                </div>
                            </div>
